...
const projection = je.Projection.EPSG3031;

const ig = new je.ImageGenerator({
	collectionUrl: "https://s3.ap-northeast-1.wasabisys.com/je-pds/cog/v1/JAXA.JASMES_GCOM-W.AMSR2_ic0.v201_south_daily/collection.json",
	band: "IC0",
